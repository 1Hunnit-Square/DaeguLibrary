    ...
    <div className="max-w-5xl mx-auto px-6 py-12 bg-white rounded-lg shadow-md">
      ...
      <section className="bg-[#eefbef] p-6 rounded-lg flex flex-col md:flex-row items-center justify-between gap-6 mb-12">
        <div className="flex-1">
          <h2 className="text-xl md:text-2xl font-bold text-green-900 mb-10">
            대구도서관 자료실 안내
          </h2>
          <p className="text-sm md:text-base text-gray-700 leading-relaxed tracking-wide">
            도서관의 자료실은 연령별, 목적별로 구분되어 다양한 정보서비스를 제공합니다.
          </p>
        </div>
      ...
      <section className="mb-12">
        <h3 className="text-xl md:text-2xl font-bold text-green-800 mb-4 border-b-4 border-green-800 inline-block pb-2">이용시간</h3>
      ...
      {/* 자료실별 이용시간 표 */}
      <section className="mb-12">
        <h3 className="text-xl md:text-2xl font-bold text-green-800 mb-4 border-b-4 border-green-800 inline-block pb-2">자료실별 이용시간</h3>
      ...
      {/* 어린이자료실 안내 */}
      <section className="mb-12">
        <h3 className="text-xl md:text-2xl font-bold text-green-800 mb-4 border-b-4 border-green-800 inline-block pb-2">어린이자료실 (1층)</h3>
        ...
        <p className="text-sm text-gray-700 leading-relaxed">
          ...
          독서교육 및 문화프로그램도 함께 운영됩니다. <br />
          <strong>이용시간:</strong> 09:00 ~ 18:00 (화~일)
        </p>
      </section>

      {/* 일반자료실 안내 */}
      <section>
        <h3 className="text-xl md:text-2xl font-bold text-green-800 mb-4 border-b-4 border-green-800 inline-block pb-2">자료실 1·2·3·4 (2~3층)</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        ...
        <p className="text-sm text-gray-700 leading-relaxed">
          ...
          <strong>이용시간:</strong> 평일 09:00~21:00 / 주말 09:00~18:00
        </p>
      </section>
    </div>
  );
