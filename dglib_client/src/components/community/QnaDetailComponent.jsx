...
const QnaDetailComponent = () => {
    ...
    if (!question) return <div>불러오는 중입니다...</div>;
    if (!isVisible)
        return (
                ...
                <tbody>
                    ...
                    {question.modifiedAt && (
                        <tr className="border-b">
                            ...
                            <td className="p-2">{question.modifiedAt.sybstring(0, 10)}</td>
                        </tr>
                    )}
                    <tr>
                    ...
                    <table className="w-full border border-gray-300 mb-8">
                        <tbody>
                            ...
                            {question.answer.modifiedAt && (
                                <tr className="border-b">
                                    <td className="bg-gray-100 p-2 font-semibold">수정일</td>
                                    <td className="p-2">{question.answer.modifiedAt.sybstring(0, 10)}</td>
                                </tr>
                            )}
                            <tr>
                                <td className="bg-gray-100 p-2 font-semibold">내용</td>
