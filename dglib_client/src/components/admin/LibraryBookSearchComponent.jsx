              ...
              <div className="overflow-x-auto">
                <table className="w-full bg-white table-fixed">
                  <thead className="bg-[#00893B] text-white">
                    <tr>
                      <th className="py-3 px-2 text-left text-sm font-semibold uppercase" style={{ width: '8%' }}>등록번호</th>
                      <th className="py-3 px-2 text-left text-sm font-semibold uppercase" style={{ width: '20%' }}>도서명</th>
                      <th className="py-3 px-2 text-left text-sm font-semibold uppercase" style={{ width: '15%' }}>저자</th>
                      <th className="py-3 px-2 text-left text-sm font-semibold uppercase" style={{ width: '15%' }}>ISBN</th>
                      <th className="py-3 px-2 text-left text-sm font-semibold uppercase" style={{ width: '8%' }}>청구번호</th>
                      <th className="py-3 px-2 text-left text-sm font-semibold uppercase" style={{ width: '7%' }}>보관장소</th>
                      <th className="py-3 px-2 text-left text-sm font-semibold uppercase" style={{ width: '12%' }}>출판사</th>
                      <th className="py-3 px-2 text-center text-sm font-semibold uppercase" style={{ width: '5%' }}>출판일</th>
                      <th className="py-3 px-2 text-center text-sm font-semibold uppercase" style={{ width: '5%' }}>대출</th>
                      <th className="py-3 px-2 text-center text-sm font-semibold uppercase" style={{ width: '5%' }}>예약</th>
                    </tr>
                  </thead>
                  <tbody className="text-gray-700">
                    {searchResults.map((book, index) => (
                      ...
                      >
                        ...
                        <td className="py-2 px-2 font-medium overflow-hidden text-ellipsis whitespace-nowrap" title={book.bookTitle}>{book.bookTitle}</td>
                        <td className="py-2 px-2 overflow-hidden text-ellipsis whitespace-nowrap" title={book.author}>{book.author}</td>
                        ...
                        <td className="py-2 px-2 overflow-hidden text-ellipsis whitespace-nowrap" title={book.publisher}>{book.publisher}</td>
