...
const MemberShipComponent = () => {
    ...
    return (
        <section className="px-6 py-12 max-w-6xl mx-auto text-gray-800">
            {/* 헤더 영역 */}
            <div className="bg-green-100 border border-green-300 p-8 rounded-xl flex flex-col md:flex-row items-center justify-between mb-12 shadow-md">
                <div className="mb-4 md:mb-0 md:w-3/4">
                    <h1 className="text-3xl font-extrabold text-gray-900 mb-2">회원가입</h1>
                    <p className="text-sm text-gray-800">
                        도서관 회원이 되시면 다양한 자료를 이용하실 수 있고, 문화행사 참여와 도서 대출 서비스를 이용하실 수 있습니다.
                    </p>
                </div>
                <img src="/signup.png" alt="회원가입 이미지" onClick={() => navigate(`/signup`)} className="hover:cursor-pointer w-20 md:w-15" />
            </div>

            {/* 가입 대상 */}
            <div className="mb-14">
                <h2 className="text-2xl font-bold text-green-800 mb-6 border-b-4 border-green-600 inline-block pb-2">회원 가입 대상</h2>
            ...
            <div className="mb-14">
                <div className="flex flex-col md:flex-row md:items-center gap-10 mb-5">
                    <h2 className="text-2xl font-bold text-green-800 border-b-4 border-green-600 inline-block pb-2 mb-4 md:mb-0">
                        회원 가입 절차
                    </h2>
                    <Button
            ...
            {/* 구비서류 */}
            <div>
                <h2 className="text-2xl font-bold text-green-800 mb-6 border-b-4 border-green-600 inline-block pb-2">구비서류 (도서관 방문 시)</h2>
