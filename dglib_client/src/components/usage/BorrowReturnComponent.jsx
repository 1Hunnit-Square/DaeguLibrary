        ...
        <div className="max-w-5xl mx-auto px-15 py-15 bg-white rounded-lg shadow-md">
            ...
            <section className="flex items-start gap-10 mb-15">
                ...
                <div>
                    ...
                    <ul className="list-disc list-inside mt-2 space-y-1 text-gray-800">
                        ...
                        <li>귀중도서, 고서 및 양서 또는 훼손 우려가 있는 자료</li>
                        <li>도서관 열람 전용으로 지정된 자료</li>
                        <li><span className="text-red-600 font-semibold">반납자료 당일 재대출 불가</span></li>
                    </ul>
                </div>
            </section>
            ...
            <section className="flex items-start gap-10 mb-15">
                ...
                <div>
                    ...
                    <p className="mb-2 text-gray-700">
                        대구도서관 소장 자료를 무인기기를 통해 업무시간 외에도 대출할 수 있는 서비스입니다.
                    </p>
                    <ul className="list-disc list-inside space-y-1 text-gray-800">
                        <li><span className="font-semibold text-orange-600">예약신청:</span> 홈페이지에서 무인예약대출 신청 (1인 5권까지 가능)</li>
                        <li><span className="font-semibold text-orange-600">도서배출:</span> 화~토요일 16:00~16:30</li>
                        <li><span className="font-semibold text-orange-600">수령장소:</span> 도서관 1층 출입구 무인예약대출기</li>
                    </ul>
                    <p className="mt-2 text-red-600 font-semibold">※ 반드시 대출 가능 알림 문자 수신 후 방문해주세요.</p>
                </div>
            </section>
            <hr className="my-10 border-t border-green-700" />
            ...
            <section className="flex items-start gap-10 mb-15">
                ...
                <div>
                    ...
                    <ul className="list-disc list-inside space-y-1 text-gray-800">
                        <li>대출 중인 도서에 한해 1인 3권까지 예약 가능</li>
